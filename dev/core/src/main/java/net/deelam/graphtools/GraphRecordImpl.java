...
@Slf4j
@NoArgsConstructor
public class GraphRecordImpl extends GraphRecordElementImpl implements GraphRecord {
  private static final long serialVersionUID = 201508251201L;

  public static class Factory extends GraphRecord.Factory {
    @Override
    public GraphRecordImpl create(String id){
      return new GraphRecordImpl(id);
    }
    @Override
    public GraphRecordImpl create(String id, String nodeType){
      return new GraphRecordImpl(id, nodeType);      
    }
    @Override
    public GraphRecordEdgeImpl createEdge(String id, String label, String outVertex, String inVertex) {
      return new GraphRecordEdgeImpl(id, label, outVertex, inVertex);
    }
  }
  ...
  public GraphRecordImpl(String strId) {
    super(strId);
  }

  public GraphRecordImpl(final String strId, String nodeType) {
    super(strId);
  ...
  public Edge addEdge(String label, Vertex inVertex) {
    GraphRecordEdge edge = factory.createEdge(label, this, inVertex);
